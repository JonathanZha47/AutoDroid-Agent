...
def autodroid(prompt):
        ...
        droidbot_instance = DroidBot(app_path=apk_path, device_serial=device_serial, task=task, output_dir=output_dir,env_policy=env_manager.POLICY_NONE,policy_name=input_manager.POLICY_TASK,event_count= 20, timeout=-1, grant_perm=True, keep_app=True, keep_env=True)
